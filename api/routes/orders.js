...
router.get("/userId/:userId",function(req, res, next){
  ...
  const query = { text: 'select o.id, o.idusr, o.total , o.total, o.fechasolicitada, o.fechaentrega, o.descripcion, o.idestado , e.nombre , e.nombre from orden o left join estado e on o.idestado = e.id left join establecimiento l on o.lugar = l.id where o.idusr = $1 and e.id = 5' ,
  values: [userId] }
  const response = res;
